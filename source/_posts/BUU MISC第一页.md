...
![image-20231209093654842](BUU MISC第一页/image-20231209093654842.png)
...
![image-20231029010621087](BUU MISC第一页/image-20231029010621087.png)

本题来自buuctf。

附件打开是一张图片，没啥特别的

![image-20231029010704171](BUU MISC第一页/image-20231029010704171.png)

用kali工具跑一遍，没有用，拿010看看：

![image-20231029011321260](BUU MISC第一页/image-20231029011321260.png)

好家伙，flag直接放在最后：`flag{stego_is_s0_bor1ing}`。

### 4.二维码

![image-20231029003945960](BUU MISC第一页/image-20231029003945960.png)

本题来自buuctf。

题目下载下来是一个二维码图片，扫一下：

![image-20231029004112936](BUU MISC第一页/image-20231029004112936.png)

看到这段话：`secret is here`，这玩意绝对不是flag，既然是图片，那用kali的工具跑一遍：

![image-20231029004556450](BUU MISC第一页/image-20231029004556450.png)

binwalk出来一个加密的zip压缩包，不知道密码，直接用工具爆破：

![image-20231029004746711](BUU MISC第一页/image-20231029004746711.png)

爆出来密码是`7639`，解压得到文件**4number.txt**：

![image-20231029004836940](BUU MISC第一页/image-20231029004836940.png)
...
<img src="BUU MISC第一页/image-20230930163911778.png" alt="image-20230930163911778" style="zoom:50%;" />

xxxxxxxxxx if(a) {    if(b) {        xxx    }else{        xxxx    }}else{    xxxxx}c

![image-20230930164004910](BUU MISC第一页/image-20230930164004910.png)
...
![image-20231209094139199](BUU MISC第一页\image-20231209094139199.png)

![image-20231209094240801](BUU MISC第一页\image-20231209094240801.png)

得到一个png图片，是一张二维码：

![image-20231209094302547](BUU MISC第一页\image-20231209094302547.png)

![image-20231209094335558](BUU MISC第一页\image-20231209094335558.png)
